...
const apellido = localStorage.getItem('apellido')
  ...
  // Si el token ya no es válido, cerramos la sesión automáticamente
...
<div>
  ...
  <span
    className={`${styles.badge} ${styles[`badge__${role?.toLowerCase()}`] ?? ''}`}
  >
    {role}
  </span>
...
<td className={styles.td}>
  ...
  <div style={{ padding: '10px' }}>
    <p className={styles.permissionMessage}> No está autorizado a crear usuarios nuevos. </p>

    <p className={styles.permissionSubMessage}> Solo un usuario <strong>ROOT</strong> puede realizar esta operación. </p>
